...
# Patterns to find the <p> tags containing the target data-zh strings
PATTERNS = [
...
def purify_page(file_path):
    ...
    for pattern in PATTERNS:
        # DOTALL to handle tags that might span multiple lines
    ...
    if content != initial_content:
        ...
        print(f"No match found or already clean: {file_path}")
